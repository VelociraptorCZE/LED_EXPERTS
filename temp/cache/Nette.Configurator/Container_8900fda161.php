<?php
// source: /home/users/raichlsimon/test-ledexperts.8u.cz/web/app/config/config.neon 
// source: /home/users/raichlsimon/test-ledexperts.8u.cz/web/app/config/config.local.neon 

class Container_8900fda161 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\BasePresenter' => [1 => ['application.3', 'application.4']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/home/users/raichlsimon/test-ledexperts.8u.cz/web/app',
			'wwwDir' => '/home/users/raichlsimon/test-ledexperts.8u.cz/web/www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/home/users/raichlsimon/test-ledexperts.8u.cz/web/app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/home/users/raichlsimon/test-ledexperts.8u.cz/web/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/home/users/raichlsimon/test-ledexperts.8u.cz/web/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/users/raichlsimon/test-ledexperts.8u.cz/web/app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=ledexdb', 'ledex',
			'Root12', null);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_8900fda161 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/users/raichlsimon/test-ledexperts.8u.cz/web/app/../temp/cache/latte');
