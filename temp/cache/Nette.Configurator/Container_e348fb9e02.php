<?php
// source: D:\_odpad\XAMPP\htdocs\Nette\_ledex__\app/config/config.neon 
// source: D:\_odpad\XAMPP\htdocs\Nette\_ledex__\app/config/config.local.neon 

class Container_e348fb9e02 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\_odpad\XAMPP\htdocs\Nette\_ledex__\app',
			'wwwDir' => 'D:\_odpad\XAMPP\htdocs\Nette\_ledex__\www',
			'debugMode' => false,
			'productionMode' => true,
			'consoleMode' => false,
			'tempDir' => 'D:\_odpad\XAMPP\htdocs\Nette\_ledex__\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\_odpad\XAMPP\htdocs\Nette\_ledex__\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\_odpad\XAMPP\htdocs\Nette\_ledex__\app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_e348fb9e02 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\_odpad\XAMPP\htdocs\Nette\_ledex__\app/../temp/cache/latte');
