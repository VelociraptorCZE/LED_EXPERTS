<?php
// source: E:\xampp\htdocs\Nette\_WEBY\_ledex\app/config/config.neon 
// source: E:\xampp\htdocs\Nette\_WEBY\_ledex\app/config/config.local.neon 

class Container_e92906074f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'E:\xampp\htdocs\Nette\_WEBY\_ledex\app',
			'wwwDir' => 'E:\xampp\htdocs\Nette\_WEBY\_ledex\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'E:\xampp\htdocs\Nette\_WEBY\_ledex\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'E:\xampp\htdocs\Nette\_WEBY\_ledex\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('E:\xampp\htdocs\Nette\_WEBY\_ledex\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('E:\xampp\htdocs\Nette\_WEBY\_ledex\app/../temp/cache',
	...
	{
		return new Container_e92906074f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_e92906074f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e92906074f $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('E:\xampp\htdocs\Nette\_WEBY\_ledex\app/../temp/cache/latte');
