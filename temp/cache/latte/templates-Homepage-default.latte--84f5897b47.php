<?php
// source: E:\xampp\htdocs\Nette\_WEBY\_ledex\LED_EXPERTS\app/templates/Homepage/default.latte

use Latte\Runtime as LR;

class Template84f5897b47 extends Latte\Runtime\Template
{
	public $blocks = [
...
<?php
	...
	{
		extract($this->params);
		if (isset($this->params['article'])) trigger_error('Variable $article overwritten in foreach on line 59');
...
?>
			...
			echo LR\Filters::escapeHtmlText($article->title) /* line 61 */ ?></h4></a>
                    <div class = articleText><?php echo LR\Filters::escapeHtmlText(call_user_func($this->filters->truncate, call_user_func($this->filters->striphtml, $article->content), 128)) /* line 62 */ ?></div>
...
<?php
		...
		$i++) {
			...
			echo LR\Filters::escapeHtmlText($i) /* line 69 */ ?></a></li>
<?php
		}
?>
        </ul>
