<?php
// source: /home/users/raichlsimon/test-ledexperts.8u.cz/web/app/templates/Homepage/contacts.latte

use Latte\Runtime as LR;

class Templatee4f19d0047 extends Latte\Runtime\Template
{
	public $blocks = [
...
<nav class="navbar navbar-light navbar-fixed-top">
    <div class="navbar-header">
      ...
      <div class = "jumbotron">
        <div class = "logo">
          <img src = "<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 46 */ ?>/images/logo2.png">
        </div>
