<?php
// source: E:\xampp\htdocs\Nette\_WEBY\_ledex\LED_EXPERTS\app/templates/Homepage/equipment.latte

use Latte\Runtime as LR;

class Template8d46c22c27 extends Latte\Runtime\Template
{
	public $blocks = [
...
<div class = "container"> 
  <img class="img-responsive" src = "<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 63 */ ?>/images/equipment-1.jpg">
  <br>
  <center><h4>Kabely</h4></center>
  <br>
  <img class="img-responsive" src = "<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 67 */ ?>/images/equipment-2.jpg">
  <br>
