<?php
// source: /home/users/raichlsimon/test-ledexperts.8u.cz/web/app/templates/Homepage/default.latte

use Latte\Runtime as LR;

class Template0b26601ae4 extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
            <div class="articlePreview">
                    <h4><?php echo LR\Filters::escapeHtmlText($article->title) /* line 49 */ ?></h4>
                    ...
                    <a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Article:default", [$article->id])) ?>"><button class = "btn btn-warning">Zobrazit článek</button></a>
            </div>          
<?php
			$iterations++;
		}
